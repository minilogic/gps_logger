...
)
{
    ...
    if(disk_status(pdrv) & STA_NOINIT) return (RES_NOTRDY); /* Check card present */
    res = RES_ERROR;
    switch (cmd){
...
{
//    return hal_card_detect_state() ? 0 : 1;
    return GPIO_getInputPinValue(GPIO_PORT_PJ, GPIO_PIN1) ? 0 : 1;
/*
